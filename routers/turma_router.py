...
def listar_turmas(
    ...
    Parâmetros:
    - periodo: Filtrar por período letivo
    - curso_codigo: Filtrar por código do curso
    - status: Filtrar por status específico
    - apenas_abertas: Retornar apenas turmas abertas para matrícula
    """
    try:
        # Aplicar filtro de "apenas_abertas"
        if apenas_abertas:
            status = "aberta"
...
def verificar_choque_horario(
    ...
    Body: {"seg": "10:00-12:00", "qui": "14:00-16:00"}
    """
    try:
